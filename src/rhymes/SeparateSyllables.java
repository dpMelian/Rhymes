...
//Edmond Duke
public class SeparateSyllables {

    private String cadena;

    public SeparateSyllables(String x){
        cadena = x;
    }

    public SeparateSyllables(){
        cadena = "";
    }

    public SeparateSyllables(int ascii[]){
        char c;
        int i;
        cadena = "";
    ...
    public SeparateSyllables(char c[]){
        int i;
        cadena = "";
